...
def show_all_questions():
    for i, question in enumerate(st.session_state['shuffled_questions'], start=1):  # Numérotation de 1 à 120
        st.write(f"**Question {i}: {question.get('Question finale', 'Question manquante')}**")
